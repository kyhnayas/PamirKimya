  ...
  return (  
    ...
    >  
      <h3 className="text-2xl font-display font-black text-primary mb-2">
        Numune ve Teknik Bilgi Talep Formu
      </h3>  
      <p className="text-text-slate text-sm mb-6 leading-relaxed">
        Sektörünüze özel dozajlama kılavuzu, ruhsat örneği ve test numunesi taleplerinizi iletebilirsiniz. En geç 24 saat içinde dönüş sağlanacaktır.
      </p>
